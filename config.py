...
que = {}
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "5153373517").split()))
API_ID = int(getenv("API_ID", "11317039"))
API_HASH = getenv("API_HASH", "6c2c3fca0802a108d2ee3223b3392ffb")
LOG_CHAT = int(getenv("LOG_CHAT", "777000"))
SPOTIFY_CLIENT_SECRET = getenv("SPOTIFY_CLIENT_SECRET", "")
SPOTIFY_CLIENT_ID = getenv("SPOTIFY_CLIENT_ID", "d7bae0c59af8420d8865bff364e55675")
SPOTIFY_USERNAME = getenv("SPOTIFY_USERNAME", "31h7cu2xpyfb3nb5stfwcz3mkn2e")
MONGO_DB = getenv("MONGO_DB", "mongodb+srv://srajput123:srajput123@cluster0.crdr7lz.mongodb.net/?retryWrites=true&w=majority")
